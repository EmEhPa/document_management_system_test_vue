...
const handleFilterChange = (filterType, value) => {
  if (isSelected(filterType, value)) {
    selectedFilters.value[filterType] = selectedFilters.value[filterType].filter(
      (item) => item !== value
    )
  } else {
...
// This component is a placeholder for the search filters UI. It currently displays static filter
options for demonstration purposes. // Later on these filter section needs to be more dynamic and
interactive, allowing users to select and apply them to their search queries.
